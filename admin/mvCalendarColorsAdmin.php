...
class mvCalendarColorsAdmin extends mvWpAdmin {
		//////////////////////////////////////////////////////////////////////////////
		// Admin Funktionalität initialisieren.
		//////////////////////////////////////////////////////////////////////////////
		public function initAdminFunctions() {
				$this->addAdminSubMenu('mvcam', 'Farben', 'Farben', 'manage_options', 'mvcam_calendar_colors');
		}
		...
		public function adminPageRender() {
				$this->setModel('mvclickandmeet_namespace\\mvCalendarColors');
		...
		public function addTextVariables() {
				$this->setTextVariable('listing_title', 'Farben');
				$this->setTextVariable('editor_title', 'Farben');
