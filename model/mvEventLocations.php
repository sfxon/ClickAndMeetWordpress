...
class mvEventLocations extends mvWpModel {
		...
		public function installDB() {
				...
				$sql = 'INSERT INTO `aloha_event_locations` (`id`, `title`, `description`, `user_id`, `email_address`, `booking_info_by_mail`) VALUES
						(1,	\'Hornberg Möbel, Essen\',	\'Unser Ladengeschäft in Essen. Straße und Anschrift, ...\', 0, \'clickandmeetwp-demo@mindfav.com\', 0);';
				$wpdb->query($sql);
		}
		...
		public function updateDB() {
				...
				//Update 1 - 2019-11-19 - Installation..
				...
				if($current_version >= 1.0 && $current_version < 1.1) {
						$sql = 
								'ALTER TABLE `aloha_event_locations` ' .
